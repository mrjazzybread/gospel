Require Import Stdlib.ZArith.BinInt stdpp.base.
  ...
  Module Declarations.
      ...
      Class _app_sig`{ @_sequence_sig } := {
        app : forall { A }, forall `{ Inhabited A },  (sequence A) -> (sequence A) -> (sequence A)
      }.

      Class _seq_get_sig`{ @_sequence_sig } := {
        seq_get : forall { A }, forall `{ Inhabited A },  (sequence A) -> Z -> A
      }.

      Class _seq_sub_sig`{ @_sequence_sig } := {
        seq_sub : forall { A }, forall `{ Inhabited A },  (sequence A) -> Z -> (Z -> (sequence A))
      }.

      Class _seq_sub_l_sig`{ @_sequence_sig } := {
        seq_sub_l : forall { A }, forall `{ Inhabited A },  (sequence A) -> Z -> (sequence A)
      }.
      ...
      Class _monoid_sig:= {
        monoid : forall { A }, forall `{ Inhabited A },  (A -> A -> A) -> A -> Prop
      }.
      ...
      Class _comm_monoid_sig:= {
        comm_monoid : forall { A }, forall `{ Inhabited A },  (A -> A -> A) -> A -> Prop
      }.

      Class _comm_monoid_def_sig`{ @_comm_monoid_sig } `{ @_monoid_sig } := {
        comm_monoid_def : forall { A }, forall `{ Inhabited A },  forall
          (f :A -> A -> A)
          (neutral :A),
      ...
      Module Sequence.
          ...
          Class _in_range_sig`{ @_sequence_sig } := {
            in_range : forall { A }, forall `{ Inhabited A },  (t A) -> Z -> Prop
          }.
          ...
          Class _init_sig`{ @_sequence_sig } := {
            init : forall { A }, forall `{ Inhabited A },  Z -> (Z -> A) -> (t A)
          }.
          ...
          Class _cons_sig`{ @_sequence_sig } := {
            cons : forall { A }, forall `{ Inhabited A },  A -> (t A) -> (t A)
          }.
          ...
          Class _snoc_sig`{ @_sequence_sig } := {
            snoc : forall { A }, forall `{ Inhabited A },  (t A) -> A -> (t A)
          }.
          ...
          Class _append_sig`{ @_sequence_sig } := {
            append : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (t A)
          }.
          ...
          Class _append_elems_left_sig`{ @_sequence_sig }
            ...
            `{ @_app_sig _ }
            := {
            append_elems_left : forall { A }, forall `{ Inhabited A },  forall
              (s :sequence A)
              (s' :sequence A)
              (i :Z),
          ...
          Class _append_elems_right_sig`{ @_sequence_sig }
            ...
            `{ @_app_sig _ }
            := {
            append_elems_right : forall { A }, forall `{ Inhabited A },  forall
              (s :sequence A)
              (s' :sequence A)
              (i :Z),
          ...
          Class _multiplicity_sig`{ @_sequence_sig } := {
            multiplicity : forall { A }, forall `{ Inhabited A },  A -> (t A) -> Z
          }.
          ...
          Class _mult_empty_sig`{ @_sequence_sig }
            ...
            `{ @_empty_sig _ }
            := {
            mult_empty : forall { A }, forall `{ Inhabited A },  forall (x :A),  (multiplicity x empty) = 0
          }.
          ...
          Class _mult_cons_neutral_sig`{ @_sequence_sig }
            ...
            `{ @_cons_sig _ }
            := {
            mult_cons_neutral : forall { A }, forall `{ Inhabited A },  forall
              (s :sequence A)
              (x1 :A)
              (x2 :A),
          ...
          Class _belongs_sig`{ @_sequence_sig } := {
            belongs : forall { A }, forall `{ Inhabited A },  A -> (t A) -> Prop
          }.

          Class _mem_sig`{ @_sequence_sig } := {
            mem : forall { A }, forall `{ Inhabited A },  A -> (t A) -> Prop
          }.
          ...
          Class _neg_belongs_sig`{ @_sequence_sig } := {
            neg_belongs : forall { A }, forall `{ Inhabited A },  A -> (t A) -> Prop
          }.
          ...
          Class _Forall_sig`{ @_sequence_sig } := {
            Forall : forall { A }, forall `{ Inhabited A },  (A -> Prop) -> (sequence A) -> Prop
          }.
          ...
          Class _Exists_sig`{ @_sequence_sig } := {
            Exists : forall { A }, forall `{ Inhabited A },  (A -> Prop) -> (sequence A) -> Prop
          }.
          ...
          Class _map_sig`{ @_sequence_sig } := {
            map : forall { A } { B }, forall `{ Inhabited A } `{ Inhabited B },  (A -> B) -> (t A) -> (t B)
          }.
          ...
          Class _filter_sig`{ @_sequence_sig } := {
            filter : forall { A }, forall `{ Inhabited A },  (A -> Prop) -> (t A) -> (t A)
          }.
          ...
          Class _get_sig`{ @_sequence_sig } := {
            get : forall { A }, forall `{ Inhabited A },  (t A) -> Z -> A
          }.
          ...
          Class _set_sig`{ @_sequence_sig } := {
            set : forall { A }, forall `{ Inhabited A },  (t A) -> Z -> (A -> (t A))
          }.
          ...
          Class _permut_sig`{ @_sequence_sig } := {
            permut : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> Prop
          }.
          ...
          Class _permut_sub_sig`{ @_sequence_sig } := {
            permut_sub : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (Z -> Z -> Prop)
          }.
      ...
      Module Bag.
          ...
          Class _empty_mult_sig`{ @_bag_sig }
            ...
            `{ @_empty_sig _ }
            := {
            empty_mult : forall { A }, forall `{ Inhabited A },  forall (x :A),  (multiplicity x empty) = 0
          }.
          ...
          Class _add_sig`{ @_bag_sig } := {
            add : forall { A }, forall `{ Inhabited A },  A -> (t A) -> (t A)
          }.
          ...
          Class _singleton_fun_def_sig`{ @_bag_sig }
            ...
            `{ @_singleton_sig _ }
            := {
            singleton_fun_def : forall { A }, forall `{ Inhabited A },  forall
              (x :A),
          ...
          Class _remove_sig`{ @_bag_sig } := {
            remove : forall { A }, forall `{ Inhabited A },  A -> (t A) -> (t A)
          }.
          ...
          Class _remove_mult_neg_x_sig`{ @_bag_sig }
            ...
            `{ @_remove_sig _ }
            := {
            remove_mult_neg_x : forall { A }, forall `{ Inhabited A },  forall
              (x :A)
              (y :A)
              (b :bag A),
          ...
          Class _union_sig`{ @_bag_sig } := {
            union : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (t A)
          }.
          ...
          Class _sum_sig`{ @_bag_sig } := {
            sum : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (t A)
          }.
          ...
          Class _inter_sig`{ @_bag_sig } := {
            inter : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (t A)
          }.
          ...
          Class _disjoint_sig`{ @_bag_sig } := {
            disjoint : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> Prop
          }.
          ...
          Class _diff_sig`{ @_bag_sig } := {
            diff : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> (t A)
          }.
          ...
          Class _subset_sig`{ @_bag_sig } := {
            subset : forall { A }, forall `{ Inhabited A },  (t A) -> (t A) -> Prop
          }.
          ...
          Class _of_seq_multiplicity_sig`{ @_sequence_sig }
            ...
            `{ @_of_seq_sig _ _ }
            := {
            of_seq_multiplicity : forall { A }, forall `{ Inhabited A },  forall
              (s :sequence A)
              (x :A),
      ...
      Module _Set.
          ...
          Class _empty_mem_sig`{ @_set_sig }
            ...
            `{ @_empty_sig _ }
            := {
            empty_mem : forall { A }, forall `{ Inhabited A },  forall (x :A),  neg_belongs x empty
          }.
          ...
          Class _partition_sig`{ @_set_sig } := {
            partition : forall { A }, forall `{ Inhabited A },  (A -> Prop) -> (t A) -> (Corelib.Init.Datatypes.prod (t A) (t A))
          }.
          ...
          Class _partition_l_mem_sig`{ @_set_sig }
            ...
            `{ @_partition_sig _ }
            := {
            partition_l_mem : forall { A }, forall `{ Inhabited A },  forall
              (f :A -> Prop)
              (s :set A)
              (x :A)
              (p1 :set A)
          ...
          Class _partition_r_mem_sig`{ @_set_sig }
            ...
            `{ @_partition_sig _ }
            := {
            partition_r_mem : forall { A }, forall `{ Inhabited A },  forall
              (f :A -> Prop)
              (s :set A)
              (x :A)
              (p1 :set A)
          ...
          Class _finite_def_sig`{ @_set_sig }
            ...
            finite_def : forall { A }, forall `{ Inhabited A },  forall
              (s :set A),
               (finite s) <-> (exists (seq :sequence A),  forall (x :A),  (belongs x s) -> (Sequence.belongs x seq))
          }.

          Class _cardinal_nonneg_sig`{ @_set_sig } `{ @_cardinal_sig _ } := {
            cardinal_nonneg : forall { A }, forall `{ Inhabited A },  forall
              (s :set A),
               (cardinal s) >= 0
          }.
          ...
          Class _cardinal_remove_mem_sig`{ @_set_sig }
            ...
            `{ @_remove_sig _ }
            := {
            cardinal_remove_mem : forall { A }, forall `{ Inhabited A },  forall
              (s :set A)
              (x :A),
          ...
          Class _cardinal_remove_not_mem_sig`{ @_set_sig }
            ...
            `{ @_remove_sig _ }
            := {
            cardinal_remove_not_mem : forall { A }, forall `{ Inhabited A },  forall
              (s :set A)
              (x :A),
          ...
          Class _cardinal_add_mem_sig`{ @_set_sig }
            ...
            `{ @_add_sig _ }
            := {
            cardinal_add_mem : forall { A }, forall `{ Inhabited A },  forall
              (s :set A)
              (x :A),
          ...
          Class _fold_def_sig`{ @_set_sig }
            ...
            fold_def : forall { A } { B }, forall
              ...
              (s :set A)
              (acc :B),
               (finite s) -> (comm_monoid m acc) -> ((fold f m s acc) = (Sequence.fold_right (fun (x :A)
            =>
      ...
      Class _map_set_sig:= {
        map_set : forall { A } { B }, forall `{ Inhabited A } `{ Inhabited B },  (A -> B) -> A -> (B -> A -> B)
      }.
      ...
      Class _map_set_def_neq_sig`{ @_map_set_sig } := {
        map_set_def_neq : forall { A } { B }, forall
          `{ Inhabited A }
          `{ Inhabited B },
           forall (f :A -> B),  forall (x :A),  forall (y :B),  forall (z :A),  (x <> z) -> ((map_set f x y z) = (f z))
      }.
