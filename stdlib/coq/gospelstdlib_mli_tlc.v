...
Parameter None : forall {A : Type}, forall {Ih_A : Inhab A}, option A.
...
Parameter empty : forall {A : Type}, forall {Ih_A : Inhab A}, t A.

Axiom empty_length :
  forall {A : Type},
  forall {Ih_A : Inhab A},
  ((@length A Ih_A empty) = 0).
