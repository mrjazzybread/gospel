...
(*@ requires let capacity = match capacity with
    ...
    let a = create ?capacity ~dummy in
...
(*@ requires 0 <= n
    ...
    modifies a2
    let _ = blit a1 ofs1 a2 ofs2 n in
